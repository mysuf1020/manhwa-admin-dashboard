<div class="md:grid-cols-3 gap-6 mb-8 grid grid-cols-1">
	...
	<div class="bg-slate-900 border-slate-800 rounded-xl p-6 shadow-lg border">
		...
		<p class="text-3xl font-bold text-white">4,092</p>
	</div>
	<div class="bg-slate-900 border-slate-800 rounded-xl p-6 shadow-lg border">
		<h3 class="text-slate-400 text-sm font-medium mb-1">Total Views</h3>
		<p class="text-3xl font-bold text-white">8.4M</p>
	</div>
</div>
		...
		<table class="w-full min-w-max border-collapse text-left">
			...
			<tbody class="divide-slate-800 divide-y">
				<tr class="hover:bg-slate-800/50 transition-colors">
					<td class="py-3 px-6 text-sm font-medium text-white">Solo Leveling</td>
					<td class="py-3 px-6 text-sm text-slate-300">Ch. 200</td>
					<td class="py-3 px-6 text-sm text-slate-400">2 mins ago</td>
					<td class="py-3 px-6 text-right">
						<button class="text-slate-400 hover:text-white px-3 py-1 bg-slate-800 rounded text-xs"
							>Edit</button
						>
					</td>
				</tr>
				<tr class="hover:bg-slate-800/50 transition-colors">
					<td class="py-3 px-6 text-sm font-medium text-white">Lookism</td>
					<td class="py-3 px-6 text-sm text-slate-300">Ch. 430</td>
					<td class="py-3 px-6 text-sm text-slate-400">1 hour ago</td>
					<td class="py-3 px-6 text-right">
						<button class="text-slate-400 hover:text-white px-3 py-1 bg-slate-800 rounded text-xs"
							>Edit</button
						>
