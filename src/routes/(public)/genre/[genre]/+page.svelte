...
<div class="max-w-7xl px-4 py-6 mx-auto">
	<div class="mb-6">
		<a href="/" class="text-sm text-slate-400 hover:text-purple-400 transition-colors">&larr; Kembali ke Beranda</a>
		<h1 class="text-2xl md:text-3xl font-black text-white mt-2">Genre: <span class="text-purple-400">{data.genre}</span></h1>
		<p class="text-sm text-slate-400 mt-1">{data.comics.length} komik ditemukan</p>
	</div>
