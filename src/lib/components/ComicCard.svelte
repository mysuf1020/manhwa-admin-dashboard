...
>
	<img
		...
		loading="lazy"
	/>
	<div style="position: absolute; inset: 0; background: linear-gradient(to top, rgba(0,0,0,0.9), rgba(0,0,0,0.3) 50%, transparent);"></div>
	{#if isHot}
	...
	<div style="position: absolute; bottom: 0; left: 0; right: 0; padding: 12px;">
		<h3 class="font-bold text-white text-xs md:text-sm mb-1 group-hover:text-purple-400 line-clamp-2 transition-colors leading-tight" style="text-shadow: 0 1px 3px rgba(0,0,0,0.8);">
			{comic.title}
		</h3>
